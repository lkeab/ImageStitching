/****************************************************************************
** Meta object code from reading C++ file 'CSimpleThread.h'
**
...
#error "The header file 'CSimpleThread.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CSimpleThread_t, stringdata) + ofs \
...
const QMetaObject CSimpleThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_CSimpleThread.data,
      qt_meta_data_CSimpleThread,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CSimpleThread.stringdata))
